...
define( 'ICL_SITEPRESS_VERSION', '3.2' );
//define('ICL_SITEPRESS_DEV_VERSION', '3.2-RC1');
...
define( 'ICL_PLUGIN_URL', wpml_filter_include_url( rtrim( plugin_dir_url( __FILE__ ), DIRECTORY_SEPARATOR ) ) );

if ( wpml_version_is('3.2')
     && !icl_get_setting('TP_ICL_MIGRATION')
     && wpml_site_uses_icl() ) {
	wpml_set_plugin_as_inactive();
...
require ICL_PLUGIN_PATH . '/inc/taxonomy-term-translation/wpml-translation-tree.class.php';
...
require ICL_PLUGIN_PATH . '/menu/taxonomy-translation-display.class.php';
...
require ICL_PLUGIN_PATH . '/inc/url-handling/wpml-root-page.class.php';
...
load_query_filter ( icl_get_setting ( 'setup_complete' ) );
