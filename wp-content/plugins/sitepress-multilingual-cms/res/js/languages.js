...
jQuery(document).ready(function(){
    ...
    jQuery('#icl_setup_back_2').click({step: "1"}, iclSetupStep);
...
function bindHoverColor(element, colorA, colorB){
...
function iclRenderLangPreview() {
    ...
    if (icl_lp_font_other_hover) {
        ...
        bindHoverColor(default_lang_link_text, icl_lp_font_other_hover, icl_lp_font_other_normal);
        bindHoverColor(lang_link, icl_lp_font_other_hover, icl_lp_font_other_normal);
    }

    if (icl_lp_background_other_normal) {
        default_lang_link.css('background-color', icl_lp_background_other_normal);
        bindHoverColor(default_lang_link, '', icl_lp_background_other_normal);
        lang_link.css('background-color', icl_lp_background_other_normal);
        bindHoverColor(lang_link, '', icl_lp_background_other_normal);
    }
    if (icl_lp_background_other_hover) {
        bindHoverColor(default_lang_link, icl_lp_background_other_hover, icl_lp_background_other_normal);
        bindHoverColor(lang_link, icl_lp_background_other_hover, icl_lp_background_other_normal);
    }
    ...
    if (icl_lp_font_current_hover) {
        ...
        bindHoverColor(lang_sel_first_text, icl_lp_font_current_hover, icl_lp_font_current_normal);
    }
    ...
    if (icl_lp_background_current_normal) {
        ...
        bindHoverColor(lang_sel_first, '', icl_lp_background_current_normal);
        bindHoverColor(lang_sel_list.find('a.lang_sel_sel'), '', icl_lp_background_current_normal);
    }

    if (icl_lp_background_current_hover) {
        bindHoverColor(lang_sel_first, icl_lp_background_current_hover, icl_lp_background_current_normal);
        bindHoverColor(lang_sel_list.find('a.lang_sel_sel'), icl_lp_background_current_hover, icl_lp_background_current_normal);
    }
...
function iclRenderLangPreviewFooter() {
    ...
    if (icl_lp_footer_font_other_hover) {
        ...
        bindHoverColor(footer_link_text, icl_lp_footer_font_other_hover, icl_lp_footer_font_other_normal);
    }

    if (icl_lp_footer_background_other_normal) {
        footer_link.css('background-color', icl_lp_footer_background_other_normal);
        bindHoverColor(footer_link, '', icl_lp_footer_background_other_normal);
    }
    if (icl_lp_footer_background_other_hover) {
        bindHoverColor(footer_link, icl_lp_footer_background_other_hover, icl_lp_footer_background_other_normal);
    }
    ...
    if (icl_lp_footer_font_current_hover) {
        ...
        bindHoverColor(lang_sel_footer_text, icl_lp_footer_font_current_hover, icl_lp_footer_font_current_normal);
    }
    ...
    if (icl_lp_footer_background_current_normal) {
        ...
        bindHoverColor(lang_sel_footer.find('a:first'), '', icl_lp_footer_background_current_normal);
    }

    if (icl_lp_footer_background_current_hover) {
        bindHoverColor(lang_sel_footer.find('a:first'), icl_lp_footer_background_current_hover, icl_lp_footer_background_current_normal);
    }
}
